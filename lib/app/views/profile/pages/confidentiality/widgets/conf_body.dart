...
class ConfBody extends StatelessWidget {
  const ConfBody({super.key});

  @override
  Widget build(BuildContext context) {
    final width = MediaQuery.sizeOf(context).width;
    final themeS = Theme.of(context).textTheme.bodySmall;
    return Column(
      ...
      children: [
        ...
        Gap(width * 0.05),
        socialmediaView(width, Theme.of(context), context),
        Gap(width * 0.03),
        const CustomFooter(isWhite: false),
      ],
    );
  }
